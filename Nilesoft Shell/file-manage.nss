menu(where=sel.count>0 type='file|dir|drive|namespace|back' mode="multiple" title='File manage' image=image.glyph(\uF07B, #000000, 12, "BigBlueTermPlus Nerd Font Propo"))
{
	...
	menu(separator="after" image=image.glyph(\uEFA4, #000000, 12, "BigBlueTermPlus Nerd Font Propo") title=title.select)
	{
