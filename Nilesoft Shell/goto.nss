menu(type='*' where=window.is_taskbar||sel.count mode=mode.multiple title=title.go_to sep=sep.both image=image.glyph(\uF124, #000000, 14, "BigBlueTermPlus Nerd Font Propo"))
{
	menu(title='Folder' image=image.glyph(\uF07C, #000000, 14, "BigBlueTermPlus Nerd Font Propo"))
	{
	...
	item(title=title.control_panel image=image.glyph(\uF013, #000000, 14, "BigBlueTermPlus Nerd Font Propo") cmd='shell:::{5399E694-6CE5-4D6C-8FCE-1D8870FDCBA0}')
	item(title='All Control Panel Items' image=image.glyph(\uF013, #000000, 14, "BigBlueTermPlus Nerd Font Propo")  cmd='shell:::{ED7BA470-8E54-465E-825C-99712043E01C}')
	item(title=title.run image=image.glyph(\uF489, #000000, 14, "BigBlueTermPlus Nerd Font Propo")  cmd='shell:::{2559a1f3-21d7-11d4-bdaf-00c04f60b9f0}')
	menu(where=sys.ver.major >= 10 title=title.settings sep=sep.before image=image.glyph(\uF013, #000000, 14, "BigBlueTermPlus Nerd Font Propo"))
	{
